  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Data Pemesanan / Tambah Data Pemesanan</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          if(isset($_POST['simpan']))
          {
            ...
            elseif ($bulanpesan==$desember)
            {
              $bulan = "Desember";
                ...
                mysqli_query($con,"INSERT INTO tbl_pemesanan (no_tiket, jumlah_anak, jumlah_dewasa, tgl_datang, sub_harga_anak, sub_harga_dewasa,total_pengunjung, total_harga, stts, bukti_bayar, peran, no_hp , nama_mitra, bulan, tahun) VALUES ('$no_tiket','$jumlahanak','$jumlahdewasa', '$tanggaldatang' ,'$subhargatiketanak', '$subhargatiketdewasa','$totalpengunjung', '$totalharga', '$stts', '$bukti', '$peran', '$nohpbener', '$nama_mitra', '$bulan','$tahunpesan')") or die(mysqli_error($con));
                ?>
                <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
                  <script>
                      ...
                      setTimeout(function(){
                      window.location.href = "../mitra_data_pemesanan";
