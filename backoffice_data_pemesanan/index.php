                        ...
                        <td>
                          <center>
                            <?php
                             ...
                             {
                               ?>
                                   <a class="btn btn-xs btn-success" href="konfirmasimitra.php?nama_petugas=<?=$_SESSION['nama'];?>&mitra=<?=$data['no_hp'];?>&no_tiket=<?=$data['no_tiket'];?>" role="button"><i class="nav-icon fas fa-check"></i></a>
                             ...
                             {
                               ?>
                                     <a class="btn btn-xs btn-success" href="konfirmasinmitra.php?nama_petugas=<?=$_SESSION['nama'];?>&no_tiket=<?=$data['no_tiket'];?>&no_hp=<?=$data['no_hp'];?>" role="button"><i class="nav-icon fas fa-check"></i></a>
