    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
                require_once "../database/config.php";
                $no_tiket =trim(mysqli_real_escape_string($con, $_POST['no_tiket']));

                $sql_cek_pengguna = mysqli_query($con,"SELECT * FROM tbl_pemesanan") or die(mysqli_error($con));
                ...
                {
                    mysqli_query($con,"DELETE FROM tbl_pemesanan WHERE no_tiket= '$no_tiket'") or die(mysqli_error($con));
            ?>
            <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
            <script>
