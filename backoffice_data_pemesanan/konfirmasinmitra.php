        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            $nmrhp = $_GET['no_hp'];
              ...
              mysqli_query($con,"UPDATE tbl_pemesanan SET no_hp='$nmrhp', nama_petugas='$petugas' , stts='Y', no_hp_petugas='$no_petugas' WHERE no_tiket='$notiket'") or die(mysqli_error($con));
